    ...
    <>
      <Router>
        <header id="header" className="header d-flex align-items-center sticky-top">
          <div className="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <nav id="navmenu" className="navmenu">
              <ul class="no-bullets">
                <NavLink to="/TH/About" activeClassName='active-link' exact><li><a className="">{tab1}</a></li></NavLink>
                {/* <NavLink to="/Products" activeClassName='active-link' exact><li><a className="">Products</a></li></NavLink> */}
                <NavLink to="/TH/Solutions" activeClassName='active-link' exact><li><a className="">{tab2}</a></li></NavLink>
                ...
                <NavLink to="/TH/Portal" activeClassName='active-link' exact><li><a className="">{tab7}</a></li></NavLink>
            ...
            <NavLink to="/TH/ContactUs" activeClassName='active-link' className="btn-getstarted" >{tab9}</NavLink>
            <LanguageSelector/>
        ...
        <Routes>
          ...
          <Route path="/TH" exact Component={Home}></Route>
          <Route path="/TH/About" exact Component={About}></Route>
          <Route path="/TH/Events&News" exact element={<Events />}></Route>
          <Route path="/TH/UpcomingNews" exact element={<UpcomingEvents />}></Route>
          <Route path="/TH/Blog" exact element={<Blog />}></Route>
          <Route path="/TH/ContactUs" exact Component={ContactUs}></Route>
          <Route path="/TH/Solutions" exact Component={Solutions}></Route>
          <Route path="/TH/Portal" exact Component={Portal}></Route>

          <Route path="/TH/Solutions/CyberSecurity" element={<CyberSecurity />} />
          <Route path="/TH/Solutions/Authentication" element={<Authentication />} />
          <Route path="/TH/Solutions/SecurityManagement" element={<SecurityManagement />} />
          <Route path="/TH/Solutions/InternetSecurity" element={<InternetSecurity />} />
          <Route path="/TH/Solutions/EndpointSecurity" element={<EndpointSecurity />} />
          <Route path="/TH/Solutions/Networking" element={<Networking />} />
          <Route path="/TH/Solutions/Infrastructure" element={<Infrastructure />} />
          <Route path="/TH/Solutions/Server" element={<Server />} />
          <Route path="/TH/Solutions/Authentication/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/CyberSecurity/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/Endpoin/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/InfrastructureMonitoring/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/Networking/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/Perimia/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/Security/:vendorName" element={<SingleVendor />} />
          <Route path="/TH/Solutions/ServerBackup/:vendorName" element={<SingleVendor />} />
